...
const Advertising = () => import(/* webpackChunkName: "advertising" */ '@/views/Advertising.vue')
const Fashion = () => import(/* webpackChunkName: "fashion" */ '@/views/Fashion.vue')
const Sport = () => import(/* webpackChunkName: "sport" */ '@/views/Sport.vue')
